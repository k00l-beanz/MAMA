...
void versionOs() {
	print("NAME\n\t"
		  "version\n\n"
		  "USAGE\n\t"
		  "Shows the current running version of OS\n\n"
		  "DESCRIPTION\n\t"
		  "By writting version the user will be able to see what is the current version the os is running on.\n\t"
		  "EXAMPLE\n\t"
		  "Current version of OS is: R1\n\t",200);
}