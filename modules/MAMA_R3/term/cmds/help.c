...
void loadr3Help() {
	print("NAME\n\t"
		  ...
		  "loadr3\n\n"
		  "DESCRIPTION\n\t"
		  "Loads all test processes into the READY queue in as SUSPENDED_READY state.\n"
		  "Each process acts as an APPLICATION and has a priority of 4\n\n",1);
}
...
void resumeallHelp() {
	printf("NAME\n\t"
		   ...
		   "resumeallpcb\n\n"
		   "DESCRIPTION\n\t"
		   "Resumes all PCB's in the READY queue\n\n");
}
...
void yieldHelp() {
	printf("NAME\n\t"
		   ...
		   "yield\n\n"
		   "DESCRIPTION\n\t"
		   "Manual interrupt. Any process in the READY queue that is not SUSPENDED will\n\t"
		   "execute until it EXIT's\n\n");
}